  ...
  'suites': [
    {
      ...
      'scored': True,
      'setup': 'get_ipython().magic(\'pylab agg\'); x,y = readTempDenFile("data/density_air.dat")',
      'teardown': "get_ipython().magic('pylab inline')",
      'type': 'doctest'
    },
    {
      'cases': [
      ...
      'scored': True,
      'setup': 'get_ipython().magic(\'pylab agg\'); x,y = readTempDenFile("data/density_water.dat")',
      'teardown': "get_ipython().magic('pylab inline')",
      'type': 'doctest'
    }
  ]
